-- Fix profiles table migration - handles existing policies
-- Run this in Supabase SQL Editor

-- First, drop existing policies if they exist (no error if they don't exist)
...
-- Create profiles table (will skip if already exists)
...
-- Optional: Create other tables if needed
...
-- Drop and recreate game_history policies
...
-- Success message
SELECT 'Profiles table and policies created successfully!' as result;